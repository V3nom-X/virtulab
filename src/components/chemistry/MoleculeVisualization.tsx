...
const moleculeData: Record<string, MoleculeData> = {
  ...
  Alanine: {
    ...
    atoms: [
      { symbol: 'C', position: [0, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.3, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.3, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [0, -1.4, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'H', position: [0, 0.5, 0.9], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [-0.5, -1.9, 0.5], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [0.5, -1.9, 0.5], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [2.6, -0.8, 0], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [-1.7, 1, 0.8], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [-1.7, 1, -0.8], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [-1.7, -0.3, 0], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 }, { from: 5, to: 9, order: 1 },
      { from: 0, to: 6, order: 1 }, { from: 3, to: 7, order: 1 }, { from: 3, to: 8, order: 1 },
      { from: 2, to: 10, order: 1 }, { from: 2, to: 11, order: 1 }, { from: 2, to: 12, order: 1 },
    ],
  },
  Valine: {
    name: 'Valine',
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.3, -0.5, 0.5], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.8, 1.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'H', position: [0, 0.5, 0.9], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 1 }, { from: 2, to: 7, order: 1 },
      { from: 0, to: 8, order: 1 },
    ],
  },
  Leucine: {
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.5, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.5, 0.7, 0.5], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-2.9, -1.6, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 1 }, { from: 6, to: 7, order: 1 }, { from: 6, to: 8, order: 1 },
    ],
  },
  Serine: {
    name: 'Serine',
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2.3, -0.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'H', position: [-2.8, 0.2, 0.5], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
  ...
  Threonine: {
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-1.8, 1.7, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.5, -0.3, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
  ...
  Cysteine: {
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.8, 1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'S', position: [-2.5, -0.3, 0], color: atomColors.S, radius: 0.8 },
      { symbol: 'H', position: [-3.2, 0.5, 0], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
  ...
  Methionine: {
    ...
    atoms: [
      ...
      { symbol: 'O', position: [2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.5, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'S', position: [-3.8, 0.5, 0], color: atomColors.S, radius: 0.8 },
      { symbol: 'C', position: [-5, -0.3, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 1 }, { from: 6, to: 7, order: 1 }, { from: 7, to: 8, order: 1 },
    ],
  },
  Phenylalanine: {
    name: 'Phenylalanine',
    ...
    atoms: [
      ...
      // Benzene ring
      { symbol: 'C', position: [-2.5, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.2, 0.9, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-4.5, 1.1, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-5.1, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-4.4, -1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.1, -1.4, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 1 },
      { from: 6, to: 7, order: 2 }, { from: 7, to: 8, order: 1 }, { from: 8, to: 9, order: 2 },
      { from: 9, to: 10, order: 1 }, { from: 10, to: 11, order: 2 }, { from: 11, to: 6, order: 1 },
    ],
  },
  Tyrosine: {
    name: 'Tyrosine',
    ...
    atoms: [
      ...
      { symbol: 'C', position: [-4.4, -1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.1, -1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-6.3, 0.2, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
  ...
  Tryptophan: {
    ...
    atoms: [
      ...
      // Indole ring
      { symbol: 'C', position: [-2.5, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.5, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [-3.2, 1.8, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [-4.3, 2.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-5.3, 1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-4.9, 0, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 3, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 1 },
      { from: 6, to: 7, order: 2 }, { from: 7, to: 8, order: 1 }, { from: 8, to: 9, order: 1 },
      { from: 9, to: 10, order: 2 }, { from: 10, to: 11, order: 1 }, { from: 11, to: 7, order: 1 },
    ],
  },
  // Vitamins
  VitaminB1: {
    ...
    atoms: [
      // Pyrimidine ring
      { symbol: 'N', position: [0, 1.2, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [1.1, 0.6, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [1.1, -0.8, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [0, -1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.1, -0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.1, 0.6, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [2.2, 1.2, 0], color: atomColors.N, radius: 0.55 },
      // Thiazole ring
      { symbol: 'C', position: [-2.4, -1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.5, -0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [-4, 0.4, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [-3.2, 1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'S', position: [-4.6, -1.8, 0], color: atomColors.S, radius: 0.8 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
      { from: 1, to: 6, order: 1 },
      { from: 4, to: 7, order: 1 }, { from: 7, to: 8, order: 2 }, { from: 8, to: 9, order: 1 },
      { from: 9, to: 10, order: 2 }, { from: 8, to: 11, order: 1 },
    ],
  },
  VitaminB2: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [-1.1, -0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.1, 0.6, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [2.2, 1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [0, -2.6, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.3, 1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-2.3, -1.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [-3.3, 0.6, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [-3.3, -0.8, 0], color: atomColors.C, radius: 0.5 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 1 },
      { from: 3, to: 4, order: 2 }, { from: 4, to: 5, order: 1 }, { from: 5, to: 0, order: 1 },
      { from: 1, to: 6, order: 2 }, { from: 3, to: 7, order: 2 },
      { from: 5, to: 8, order: 2 }, { from: 4, to: 9, order: 1 },
      { from: 8, to: 10, order: 1 }, { from: 10, to: 11, order: 2 }, { from: 11, to: 9, order: 1 },
    ],
  },
  VitaminB3: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [-1.1, 0.7, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.4, -1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [2.8, -2.4, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [3.2, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'H', position: [3.9, -0.9, 0], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
  ...
  VitaminB6: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [-1.1, 0.7, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.3, 1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [2.3, -1.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'C', position: [-2.3, -1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-2.3, -2.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [0, -2.5, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
      { from: 1, to: 6, order: 1 }, { from: 2, to: 7, order: 1 },
      { from: 4, to: 8, order: 1 }, { from: 8, to: 9, order: 1 }, { from: 3, to: 10, order: 1 },
    ],
  },
  // Organic compounds
  CitricAcid: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [1.3, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.3, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.5, -0.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-2.5, -0.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [0, -1.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [3, 0.8, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [3.2, -1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-3, 0.8, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-3.2, -1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [0.5, -2.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-0.5, -2.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [0, 1.2, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 5, order: 1 },
      { from: 0, to: 12, order: 1 }, { from: 1, to: 3, order: 1 }, { from: 2, to: 4, order: 1 },
      { from: 3, to: 6, order: 2 }, { from: 3, to: 7, order: 1 },
      { from: 4, to: 8, order: 2 }, { from: 4, to: 9, order: 1 },
      { from: 5, to: 10, order: 2 }, { from: 5, to: 11, order: 1 },
    ],
  },
  OxalicAcid: {
    name: 'Oxalic Acid',
    ...
    atoms: [
      ...
      { symbol: 'O', position: [1.2, 1.1, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [1.2, -1.1, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'H', position: [-1.8, -1.6, 0], color: atomColors.H, radius: 0.35 },
      { symbol: 'H', position: [1.8, -1.6, 0], color: atomColors.H, radius: 0.35 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 },
      { from: 0, to: 2, order: 2 }, { from: 0, to: 3, order: 1 }, { from: 3, to: 6, order: 1 },
      { from: 1, to: 4, order: 2 }, { from: 1, to: 5, order: 1 }, { from: 5, to: 7, order: 1 },
    ],
  },
  TartaricAcid: {
    name: 'Tartaric Acid',
    ...
    category: 'Organic',
    atoms: [
      { symbol: 'C', position: [-0.7, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [0.7, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.8, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.8, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-0.7, 1.7, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [0.7, 1.7, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2.3, 0.7, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2.3, -1.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, 0.7, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, -1.3, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      ...
      { from: 0, to: 4, order: 1 }, { from: 1, to: 5, order: 1 },
      { from: 2, to: 6, order: 2 }, { from: 2, to: 7, order: 1 },
      { from: 3, to: 8, order: 2 }, { from: 3, to: 9, order: 1 },
    ],
  },
  MalicAcid: {
    name: 'Malic Acid',
    ...
    atoms: [
      ...
      { symbol: 'C', position: [2.5, -0.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [0, -1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-1.8, 1.6, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2, -0.3, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [3, 0.8, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [3.2, -1.2, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 0, to: 4, order: 1 },
      { from: 1, to: 3, order: 1 },
      { from: 2, to: 5, order: 2 }, { from: 2, to: 6, order: 1 },
      { from: 3, to: 7, order: 2 }, { from: 3, to: 8, order: 1 },
    ],
  },
  SuccinicAcid: {
    name: 'Succinic Acid',
    ...
    atoms: [
      { symbol: 'C', position: [-0.7, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [0.7, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.8, -0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.8, -0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-2.3, 0.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2.3, -1.8, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, 0.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, -1.8, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 0, to: 2, order: 1 }, { from: 1, to: 3, order: 1 },
      { from: 2, to: 4, order: 2 }, { from: 2, to: 5, order: 1 },
      { from: 3, to: 6, order: 2 }, { from: 3, to: 7, order: 1 },
    ],
  },
  FumaricAcid: {
    ...
    atoms: [
      { symbol: 'C', position: [-0.6, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [0.6, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.8, -0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.8, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-2.3, 0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2.3, -1.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, -0.5, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [2.3, 1.5, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 0, to: 2, order: 1 }, { from: 1, to: 3, order: 1 },
      { from: 2, to: 4, order: 2 }, { from: 2, to: 5, order: 1 },
      { from: 3, to: 6, order: 2 }, { from: 3, to: 7, order: 1 },
    ],
  },
  ...
  Ibuprofen: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [2.8, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [3.5, 1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [4.3, 0.8, 0.9], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [4.3, 0.8, -0.9], color: atomColors.C, radius: 0.5 },
      // Propionic acid
      { symbol: 'C', position: [-2.8, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.5, 1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.5, -1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-4, 1.8, 0.9], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-4, 1.8, -0.9], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
      { from: 0, to: 6, order: 1 }, { from: 6, to: 7, order: 1 },
      { from: 7, to: 8, order: 1 }, { from: 7, to: 9, order: 1 },
      { from: 3, to: 10, order: 1 }, { from: 10, to: 11, order: 1 }, { from: 10, to: 12, order: 1 },
      { from: 11, to: 13, order: 2 }, { from: 11, to: 14, order: 1 },
    ],
  },
  Morphine: {
    name: 'Morphine',
    ...
    atoms: [
      ...
      { symbol: 'C', position: [0, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.2, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.2, -0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.2, -1.7, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.2, -2.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [0, -2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [3.3, 0.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [3.3, -2.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'N', position: [-1.2, -0.5, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [-2.3, 0.3, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-1.2, 0.8, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 2 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
      { from: 2, to: 6, order: 1 }, { from: 3, to: 7, order: 1 },
      { from: 0, to: 8, order: 1 }, { from: 8, to: 9, order: 1 },
  ...
  Penicillin: {
    ...
    atoms: [
      ...
      { symbol: 'C', position: [0, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.2, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'N', position: [1.2, -0.9, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'C', position: [0, -1.2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-0.8, 0.8, 0], color: atomColors.O, radius: 0.6 },
      // Thiazolidine ring
      { symbol: 'S', position: [2.4, 0, 0], color: atomColors.S, radius: 0.8 },
      { symbol: 'C', position: [2.8, -1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [3.5, 0.8, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [3.5, 1.8, 0.8], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [3.5, 1.8, -0.8], color: atomColors.C, radius: 0.5 },
      // Carboxyl group
      { symbol: 'C', position: [4, -2, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [4.5, -1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [4.5, -3, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 1 },
      { from: 3, to: 0, order: 1 }, { from: 0, to: 4, order: 2 },
      { from: 1, to: 5, order: 1 }, { from: 5, to: 6, order: 1 }, { from: 6, to: 2, order: 1 },
      { from: 5, to: 7, order: 1 }, { from: 7, to: 8, order: 1 }, { from: 7, to: 9, order: 1 },
      { from: 6, to: 10, order: 1 }, { from: 10, to: 11, order: 2 }, { from: 10, to: 12, order: 1 },
    ],
  },
  // Sugars
  Fructose: {
  ...
  Sucrose: {
    ...
    atoms: [
      ...
      { symbol: 'O', position: [0.6, -0.4, 0], color: atomColors.O, radius: 0.6 },
      // Bridge oxygen
      { symbol: 'O', position: [-2, 0, 0], color: atomColors.O, radius: 0.6 },
      // Fructose ring (simplified)
      { symbol: 'C', position: [-3, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-3.6, 1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-4.8, 1.4, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-5.4, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-4.8, -0.4, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 1 },
      { from: 0, to: 4, order: 1 },
      { from: 3, to: 5, order: 1 }, { from: 5, to: 6, order: 1 },
      { from: 6, to: 7, order: 1 }, { from: 7, to: 8, order: 1 }, { from: 8, to: 9, order: 1 },
      { from: 9, to: 10, order: 1 }, { from: 10, to: 6, order: 1 },
    ],
  },
  // Additional DNA base
  Guanine: {
    name: 'Guanine (DNA Base)',
    formula: 'C₅H₅N₅O',
    category: 'DNA Base',
    atoms: [
      { symbol: 'N', position: [0, 1.3, 0], color: atomColors.N, radius: 0.55 },
      ...
      { symbol: 'N', position: [-2.2, -1.2, 0], color: atomColors.N, radius: 0.55 },
      { symbol: 'O', position: [2.2, 1.2, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'N', position: [0.3, -2.5, 0], color: atomColors.N, radius: 0.55 },
    ],
    bonds: [
      ...
      { from: 5, to: 6, order: 1 }, { from: 6, to: 7, order: 2 }, { from: 7, to: 8, order: 1 },
      { from: 8, to: 4, order: 1 },
      { from: 1, to: 9, order: 2 }, { from: 3, to: 10, order: 1 },
    ],
  },
  Cytosine: {
    name: 'Cytosine (DNA Base)',
    formula: 'C₄H₅N₃O',
    category: 'DNA Base',
    atoms: [
      { symbol: 'N', position: [0, 1.2, 0], color: atomColors.N, radius: 0.55 },
      ...
      { symbol: 'C', position: [-1.1, 0.5, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [2.1, 1, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'N', position: [0, -2.7, 0], color: atomColors.N, radius: 0.55 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 2 },
      { from: 3, to: 4, order: 1 }, { from: 4, to: 5, order: 2 }, { from: 5, to: 0, order: 1 },
      { from: 1, to: 6, order: 2 }, { from: 3, to: 7, order: 1 },
    ],
  },
  // Fatty acids
  PalmiticAcid: {
    ...
    atoms: [
      { symbol: 'C', position: [0, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [1.3, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [2.6, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [3.9, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [5.2, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'C', position: [-1.3, 0, 0], color: atomColors.C, radius: 0.5 },
      { symbol: 'O', position: [-1.8, 1.1, 0], color: atomColors.O, radius: 0.6 },
      { symbol: 'O', position: [-2, -1, 0], color: atomColors.O, radius: 0.6 },
    ],
    bonds: [
      { from: 0, to: 1, order: 1 }, { from: 1, to: 2, order: 1 }, { from: 2, to: 3, order: 1 },
      { from: 3, to: 4, order: 1 }, { from: 0, to: 5, order: 1 },
      { from: 5, to: 6, order: 2 }, { from: 5, to: 7, order: 1 },
    ],
  },
};
...
const categoryAssignments: Record<string, string> = {
  ...
  // DNA Bases
  Adenine: 'DNA Base', Thymine: 'DNA Base', Guanine: 'DNA Base', Cytosine: 'DNA Base',
  // Pharmaceuticals  
